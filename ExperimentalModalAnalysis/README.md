...
$$ [{H(s)}]=\sum\limits_{k = 1}^n {\frac{P_k P_k^*}{m_{q,k}} \frac{1}{{s^2+ 2{\zeta _k}{\omega _{n,k}}s + \omega_{n,k}^2}}}  = \sum\limits_{k = 1}^n {\frac{{[R]}_k}{{s^2} + 2{\zeta _k}{\omega _{n,k}}s + \omega_{n,k}^2}} $$
